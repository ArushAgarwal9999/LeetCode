...
class Solution
{
    ...
    public void traversal(Node root , PriorityQueue<Integer> quee)
    {
        if(root == null)
            return ;
        traversal(root.left,quee);
        quee.add(root.data);
        traversal(root.right,quee);
    }
    public void check(Node root , PriorityQueue<Integer> quee)
    {
        if(root==null)
        {
            return ;
        }
        check(root.left,quee);
